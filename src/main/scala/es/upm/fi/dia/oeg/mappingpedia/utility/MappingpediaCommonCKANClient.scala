...
import es.upm.fi.dia.oeg.mappingpedia.utility.MappingpediaCommonCKANClient.logger
...
class MappingpediaCommonCKANClient(val ckanUrl: String, val authorizationToken: String) {
...
object MappingpediaCommonCKANClient {
  val logger: Logger = LoggerFactory.getLogger(this.getClass);
