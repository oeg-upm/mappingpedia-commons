...
import es.upm.fi.dia.oeg.mappingpedia.utility.MappingpediaCommonCKANUtility.logger
...
class MappingpediaCommonCKANUtility(val ckanUrl: String, val authorizationToken: String) {
...
object MappingpediaCommonCKANUtility {
  val logger: Logger = LoggerFactory.getLogger(this.getClass);
