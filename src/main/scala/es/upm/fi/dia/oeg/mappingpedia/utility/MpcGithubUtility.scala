...
/**
  ...
  */
class MpcGithubUtility(githubRepository:String, githubUsername:String, githubAccessToken:String) {
  ...
  def encodeAndPutFile(organizationId:String, datasetId:String, filename:String, message:String, file:File) = {
    val base64EncodedContent = MpcGithubUtility.encodeToBase64(file);
