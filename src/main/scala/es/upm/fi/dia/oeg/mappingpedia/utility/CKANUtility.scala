...
class CKANUtility(val ckanUrl: String, val authorizationToken: String) {
  ...
  val CKAN_API_ACTION_ORGANIZATION_CREATE_URL = ckanUrl + "/api/action/organization_create";
  val CKAN_API_ACTION_ORGANIZATION_UPDATE_URL = ckanUrl + "/api/action/organization_update";
  ...
  def addNewOrganization(organization:Agent) = {
    ...
    val uri = CKAN_API_ACTION_ORGANIZATION_CREATE_URL
  ...
  def addNewPackage(dataset:Dataset) = {
    ...
    val uri = CKAN_API_ACTION_PACKAGE_CREATE_URL
    logger.info(s"Hitting endpoint: $uri");
  ...
  def updateDatasetLanguage(organizationId:String, datasetId:String, language:String) : Integer = {
    ...
    val uri = CKAN_API_ACTION_ORGANIZATION_UPDATE_URL
    logger.info(s"Hitting endpoint: $uri");
